...
ver <- c('HG001_00625','HG001_00516','HG001_02338',
         'HG001_01977','HG001_02583','HG001_02334',
         'HG001_01615','HG001_01092','HG001_01204',
         'HG001_01150','HG001_01863','HG001_01003',
         'HG001_01295','HG001_02606',#<-RsaA (14)
         'HG001_00569','HG001_01477','HG001_01627',
         'HG001_02152','HG001_00556','HG001_00934',
         'HG001_00252','HG001_02633','HG001_00671',
         'HG001_00933','HG001_01479','HG001_00967',
         'HG001_01416','HG001_02376','HG001_01478',
         'HG001_01220','HG001_01721','HG001_02519',
         'HG001_00968','HG001_01480','HG001_02411',
         'HG001_01710','HG001_01657','HG001_00540',
         'HG001_01626','HG001_01845','HG001_01925',
         'HG001_00932','HG001_02069','HG001_00568',
         'HG001_02589',#<-RsaC (31)
         'HG001_02704','HG001_02520','HG001_01242',
         'HG001_02756','HG001_02360','HG001_01537',
         'HG001_02609','HG001_00847','HG001_02545',
         'HG001_00316','HG001_02210','HG001_02293',
         'HG001_00974','HG001_02628','HG001_00942',
         'HG001_00584')#<-RsaI (16)



######## Verified dataset target
verified <- data.frame(v=c(rep('t',61)),
                       srna=c(rep('rsaA',14),rep('rsaC',31),rep('rsaI',16)),
                       target=c(ver))
...
db<-rbind(inta,tar,plex,duplex,db_b,mir,srnar)
...
d  %>% 
  separate(a,c('alg1','alg2'),sep='-') %>% mutate(fp=0.5) %>% 
  ggplot(aes(x=fp,y=rel))+
  ylim(0,1)+xlim(0,1)+
  geom_point(aes(color=t),lwd=3)+
  geom_path()+
  ...
  ggtitle('Roc curve - Inta_star_srnarFT')+
  geom_abline(slope = 1,intercept = 0)+
  facet_grid(alg1~alg2)


ggsave('Fig/roc_mix2_genome.png', dpi=300)
...
ggsave('Fig/to_genome.png', dpi=300)
